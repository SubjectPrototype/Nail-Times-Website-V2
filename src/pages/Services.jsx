  ...
  const categories = [
    {
      ...
      services: [
        ...
        { name: "Coconut Manicure", price: 50, description: "A tropical indulgence with coconut sea salt and mask, hot towel, paraffin wax, and coconut oil massage." },
        { name: "Hot Stone Manicure", price: 52, description: "Revitalize with citrus exfoliation and warm hot stone massage to ease stiffness and enhance circulation." },
    ...
    },
    {
      ...
      services: [
        ...
        { name: "Coconut Pedicure", price: 65, description: "A deeply nourishing treatment enriched with natural coconut extracts to soothe and repair the skin. Helps improve dermatitis and other skin conditions, moisturizes deeply, and promotes healing for eczema-prone skin. Leaves your feet soft, hydrated, and naturally radiant." },
        { name: "Hot Stone Pedicure", price: 68, description: "A luxurious and therapeutic treatment that uses warm stones to ease muscle stiffness, relieve tension, and enhance circulation. The gentle heat promotes relaxation while boosting metabolism, leaving your feet and legs feeling rejuvenated, balanced, and deeply soothed." },
    ...
    },
    {
      ...
      services: [
        ...
        { name: "French Polish Change Nails", price: 20, description: "French polish finish for nails" },
        { name: "French Polish Change Toes", price: 24, description: "French polish finish for toes" },
        { name: "Soak Off", price: 18, description: "Safe product removal service" },
        { name: "Nail Repair (each)", price: 5, description: "Starts at $5 (up to $5 depending on repair)" },
        { name: "Nail Art Design", price: 5, description: "Starts at $5 and up" },
        { name: "Kid Polish Change Nails", price: 12, description: "Kid nail polish change" },
        { name: "Kid Polish Change Toes", price: 14, description: "Kid toe polish change" },
    ...
    },
    {
      title: "Add-Ons",
      services: [
        { name: "Long Lasting Topcoat", price: 4, description: "Extends the life of your polish" },
        { name: "Nail Tip Add-On", price: 10, description: "" },
        { name: "Stiletto/Coffin/Almond Shape", price: 8, description: "" },
        { name: "Cuticle Trim", price: 8, description: "Trims and shapes cuticles for a polished look" },
        { name: "Paraffin", price: 12, description: "Moisturizing treatment for hands and feet" },
        { name: "Extra Massage (10 min)", price: 16, description: "Massage add-on" },
        { name: "Callus Removal", price: 8, description: "Smooths rough skin for softer feet" },
        { name: "Hot Stone", price: 12, description: "" },
      ],
    },
    {
      title: "Waxing",
      services: [
        ...
        { name: "Eyebrow", price: 15, description: "" },
        { name: "Full Face", price: 46, description: "" },
        { name: "Dye Eyebrow", price: 24, description: "" },
        { name: "Dye Eyelash", price: 18, description: "" },
        ...
        { name: "Bikini", price: 38, description: "" },
        { name: "Arm Full", price: 38, description: "" },
        { name: "Arm Half", price: 28, description: "" },
        { name: "Legs Full", price: 62, description: "" },
        { name: "Legs Half", price: 38, description: "" },
        { name: "Brazilian", price: 70, description: "" },
      ],
    },
  ];
