  ...
  const categories = [
    {
      ...
      services: [
        ...
        { name: "Deluxe Spa Paraffin Manicure", price: 40, description: "The wax is a natural emollient, helping make skin supple, soft and moisture" },
        { name: "Lavender Manicure", price: 45, description: "Relaxing nerves and a wonderful natural anxiety treatment" },
        { name: "Aloe Vera Manicure", price: 47, description: "Healing sunburn, imperfections and soften the skin" },
        { name: "Coconut Manicure", price: 50, description: "Improves dermatitis and kin disorders, moisturizer the skin and the curer of eczema" },
        { name: "Hot Stone Manicure", price: 52, description: "Eases muscle stiffness and tension, increases circulation and metabolism" },
    ...
    },
    {
      ...
      services: [
        ...
        { name: "Spa Pedicure", price: 42, description: "Pedicure with Massage and Exfoliation" },
        { name: "Deluxe Spa Paraffin Pedicure", price: 52, description: "The wax is a natural emollient, helping make skin supple, soft and moisture" },
        { name: "Lavender Pedicure", price: 58, description: "Relaxing nerves and a wonderful natural anxiety treatment" },
        { name: "Aloe Vera Pedicure", price: 62, description: "Healing sunburn, imperfections and soften the skin" },
        { name: "Coconut Pedicure", price: 65, description: "Improves dermatitis and kin disorders, moisturizer the skin and the curer of eczema" },
        { name: "Hot Stone Pedicure", price: 68, description: "Eases muscle stiffness and tension, increases circulation and metabolism" },
